            ...
            <div class="formulario">
                <form class="text-center" action="" method="POST">
                    <div class="text-center">
                        <h1 class="text-light">ELIMINAR CUENTA</h1>

                        <div class="mb-3">
                            <label class="text-light me-5" for="contnueva">Ingrese su contraseña</label>
                            <input class="resp mb-3" type="password" name="contra">
                        </div>

                        <div class="mb-3">
                            <input class="crear" type="submit" value="eliminar" name="eliminar">
                        </div>
